        ...
        * Bootstrap v5.0.2 (https: //getbootstrap.com/)
            * Copyright 2011-2021 The Bootstrap Authors * Copyright 2011-2021 Twitter, Inc. * Licensed under MIT (https: //github.com/twbs/bootstrap/blob/main/LICENSE)
                ...
                *, ::after, ::before {
                ...
                .form-select:focus {
                    border-color:#86b7fe; outline:0; box-shadow:0 0 0 .25rem rgba(13,110,253,.25)}.form-select[multiple],.form-select[size]:not([size="1"]) {
                ...
                .form-select.is-valid, .was-validated .form-select:valid{border-color:#198754}.form-select.is-valid:not([multiple]):not([size]),.form-select.is-valid:not([multiple])[size="1"], .was-validated .form-select:valid:not([multiple]):not([size]), .was-validated .form-select:valid:not([multiple])[size="1"] {
                ...
                .form-select.is-invalid, .was-validated .form-select:invalid{border-color:#dc3545}.form-select.is-invalid:not([multiple]):not([size]),.form-select.is-invalid:not([multiple])[size="1"], .was-validated .form-select:invalid:not([multiple]):not([size]), .was-validated .form-select:invalid:not([multiple])[size="1"] {
...
<body>
    <div id="elemento-a-exportar">
        ...
        <br>
        @if ($print)
            <button id="boton-imprimir" class="btn btn-primary">Imprimir</button>-<button id="boton-imprimir"
                class="btn btn-success" onclick="export_excel({{ '"' . (string) $date . '"' }})">Exportar en Excel</button>
        @endif
                ...
                <div class="wrap-table100">
                    <div>
                        <table class="table table-hover table-striped">
                            <thead>
                                <tr>
                                    <th colspan="13" class="text-center fs-1" style="text-align: center">Matos
                                        Store - Inventario - {{ $date }} horas</th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $product)
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="fs-5" style="text-align: left"><img
                                                src="{{ app('App\Http\Controllers\ReportController')->getImage($product->id) }}"
                                                height="42px"> - {{ $product->description }}</td>
                                        ...
                                        @if ($size->quantity > 0)
                                            <tr>
                                                ...
                                                <td style="text-align: center"><b>S/
                                                        {{ $size->quantity * $product->purchase_prices }}</b></td>
                                    ...
                                    <tr class="table-info">
                                        ...
                                        <th class="table-warning" style="text-align: center"><b>S/
                                                {{ $q_prod * $product->purchase_prices }}</b></th>
                                        <td></td>
                                        <td colspan="3" style="text-align: right">Ganancias esperadas para este
                                            producto entre: </td>
                                        <th colspan="2" class="table-warning" style="text-align: center"><b>S/
                                                {{ $g_min }} y S/ {{ $g_max }}</b></th>
                                        @php
                            ...
                            <tfoot>
                                <tr class="table-dark">
                                    ...
                                    <th colspan="2" class="fs-5" style="text-align: right">Calzados disponibles:
                                    </th>
                                    ...
                                    <th colspan="4" class="fs-5" style="text-align: right">Ganancias esperadas
                                        en tienda:</th>
                                    <th colspan="2" class="fs-5" style="text-align: center"><b>S/
                                            {{ $ganancia_min_total }} y S/ {{ $ganancia_max_total }}</b></th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
