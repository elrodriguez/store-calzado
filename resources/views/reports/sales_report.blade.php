...
<body>
    <div id="elemento-a-exportar">
        ...
        <hr>
        <h2 style="padding-left: 15px">día y hora de reporte: {{ $date }} horas</h2>
                    ...
                    <div>
                        <table class="table table-hover table-striped">
                            <thead>
                                @if ($start == $end)
                                    <tr>
                                        <th colspan="7" class="text-center fs-1" style="text-align: center">Matos
                                            Store - Ventas de: {{ $start }} </th>
                                    </tr>
                                @else
                                    <tr>
                                        <th colspan="7" class="text-center fs-1" style="text-align: center">Matos
                                            Store - Ventas de: {{ $start }} al {{ $end }}</th>
                                    </tr>
                                @endif
                            ...
                            <tbody>
                                    ...
                                    @foreach ($products as $product)
                                        <tr class="">
                                            ...
                                            <td class="fs-4" style="text-align: center">
                                                {{ app('App\Http\Controllers\ReportController')->getLocal($sale->local_id) }}
                                            </td>
                                            <td class="fs-4" style="text-align: center">{{ $product->interne }}</td>
                                            <td class="fs-4" style="text-align: left"><img
                                                    src="{{ app('App\Http\Controllers\ReportController')->getImage($product->id) }}"
                                                    height="42px"> {{ $product->description }}</td>
                                            <td class="fs-4" style="text-align: center">S/ {{ $product->price }}
                                            </td>
                                            <td class="fs-4" style="text-align: center">{{ $product->quantity }}
                                            </td>
                                            <td class="fs-4" style="text-align: center">{{ $product->size }}</td>
                                            <td class="fs-4" style="text-align: center">S/
                                ...
                                @if ($x <= 1)
                                    <tr>
                                        <td colspan="7" class="fs-2" style="text-align: center">No hay Registro
                                            de ventas en el rango de fechas escogido</td>
                                    </tr>
                                @endif
                            </tbody>
                            <tfoot>
