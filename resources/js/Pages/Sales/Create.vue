    ...
    <AppLayout title="Punto de Ventas">
        ...
        <div>
            <div class="mx-auto py-2 sm:px-2 lg:px-4">
                ...
                <div class="mt-4">
                    <div v-if="$page.props.message" id="alert-border-1" class="flex p-4 mb-4 text-blue-800 border-t-4 border-blue-300 bg-blue-50 dark:text-blue-400 dark:bg-gray-800 dark:border-blue-800" role="alert">
