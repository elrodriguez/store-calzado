<script setup>
    ...
    watch(() => props.clientDefault, (newValue) => {
        // Ejecutar acción cuando cambie el valor
        //console.log('Nuevo valor en componente hijo:', newValue.full_name)
...
<template>
    <div>
        ...
        <div  id="result" style="position: absolute;width: 100%;z-index: 999999;">
            <div class="mt-1" style="max-height: 300px;overflow-y: auto;">
                <table class="min-w-full" >
                    <tbody>
                        <tr @click="selectClient(client)" v-for="(client, index) in form.clients" class="border-b bg-gray-100 boder-gray-900" style="cursor: pointer;">
        ...
        <button @click="openModalClient()" type="button" class="inline-block px-6 py-2.5 bg-transparent text-blue-600 font-medium text-xs leading-tight uppercase rounded transition duration-150 ease-in-out">Nuevo (+)</button>
    </div>
    <div>
        <ModalLarge
            :show="displayModalClient"
        ...
        >
            ...
            <template #content>
                <Form class="grid grid-cols-6 gap-4" >
                    ...
                    <div class="col-span-6 sm:col-span-2">
                        <button @click="modalNewSearchClient()" type="button" class="block w-full bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow mt-6">Buscar por Nro</button>
                    </div>
